...
import useQueryParams from "../../hooks/useQuerryParams";
import { Episode } from "../../interface";
import Storage from "../../utils/Storage";
import useFetchInfo from "../InforScreen/useFetchInfo";
import EpisodesButton from "./EpisodeButton";
...
const WatchScreen = () => {
  ...
  const handleEpisodeClick = (_episode: Episode, i: number) => {
    window.location.pathname = `/watch/${slug}?episode_index=${i}`;
    setEpisodeIndex(i);
  };
